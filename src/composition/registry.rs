...
fn get_interfaces_for_capability(kind: &str) -> Vec<String> {
    ...
    if kind == "wasi:p2" {
        return vec![
            ...
            "wasi:cli/terminal-input@0.2.12".to_string(),
            "wasi:cli/terminal-output@0.2.12".to_string(),
            "wasi:cli/terminal-stdin@0.2.12".to_string(),
            "wasi:cli/terminal-stdout@0.2.12".to_string(),
            "wasi:cli/terminal-stderr@0.2.12".to_string(),
